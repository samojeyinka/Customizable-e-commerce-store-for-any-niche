...
<div class="w-[90%] mx-auto max-w-[1440px] grid grid-cols-2 lg:grid-cols-4 gap-4 my-4">
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
        ...
        <button 
            class="add-to-cart-btn bg-[<?php echo store_color('color_primary'); ?>] text-white rounded-[8px] text-[15px] md:text-[16px] font-Onest font-medium cursor-pointer p-2 w-[90%] absolute bottom-0 left-[5%]"
