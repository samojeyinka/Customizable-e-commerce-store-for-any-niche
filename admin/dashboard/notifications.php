    ...
    <header class="w-full bg-[#FFFFFF] z-100 flex items-center justify-center p-3 border-b-[1px] border-[#F8F8F8] fixed top-0 left-0">
        <nav class="w-full md:w-[98%] lg-w-[95%] flex items-center justify-between">
            ...
            <div class="flex items-center gap-5 md:gap-8 lg:gap-10">
                ...
                <h1 class="hidden md:block  text-[16px] md:text-[20px] font-Onest font-semibold">Notifications</h1>
            </div>
    ...
    <div id="main" class="md:p-4 flex flex-col gap-3 bg-[#FAFAFA]">
        <div class="w-full rounded-[16px] bg-white mx-auto p-3">
                            ...
                            <div class="hidden md:flex items-center gap-2 md:gap-3 lg:gap-4">
                                <div class="custom-dropdown">
                                    <div class="md:min-w-[65px] lg:min-w-[70px] rounded-[4px] border-[1px] border-[#C5C5C5] flex items-center justify-between py-1 px-2 dropdown-toggle">
                                        <span class="text-[#262626] text-[13px] md:text-[14px] font-Onest font-regular">Unread</span>
                                    ...
                                    <div class="dropdown-content">
                                        <div class="flex items-center gap-3">
                                            <div class="flex flex-col gap-3 text-[13px] text-[#262626 cursor-pointer">
                                                ...
                                                <div onclick="selectOption(this)">Unread</div>
                                                <div onclick="selectOption(this)">Read</div>
            ...
            <div class="w-full justify-between overflow-x-auto flex border-b border-[#DDDDDD] mb-6" id="tabs">
                <button data-tab="all" class="text-nowrap px-4 py-2 text-[#007F7F] border-b-2 border-[#007F7F] tab-button">All</button>
                <button data-tab="orders" class="text-nowrap px-4 py-2 text-gray-600 hover:text-gray-900 tab-button">Orders</button>
                <button data-tab="transactions" class="text-nowrap px-4 py-2 text-gray-600 hover:text-gray-900 tab-button">Transactions</button>
                <button data-tab="product" class="text-nowrap px-4 py-2 text-gray-600 hover:text-gray-900 tab-button">Product Update</button>
                <button data-tab="reviews" class="text-nowrap px-4 py-2 text-gray-600 hover:text-gray-900 tab-button">Reviews</button>
            </div>
