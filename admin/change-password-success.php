...
<head>
    ...
    <title>GLOREFY ADMIN | Change Password Success</title>
...
<body>
    <div class="w-[90%] lg:w-[50%] h-[fit-content] mx-auto bg-white rounded-[24px] p-5">
        ...
        <p class="font-['Open Sans']  text-[18px] text-[22px] font-medium text-center pt-6">
            ADMIN PANEL
        </p>

        <div class="flex flex-col gap-0">

        <i class="fa-solid fa-circle-check text-[#22C55E] text-[120px] mx-auto leading-none"></i>
...
<a href="./index.php" class="text-center w-[90%] mx-auto max-w-[1440px] text-[16px] font-regular font-Satoshi py-2 px-6 bg-[#C2185B] text-white rounded-[8px] mt-10 cursor-pointer"
    >
    Sign In
    </a>
