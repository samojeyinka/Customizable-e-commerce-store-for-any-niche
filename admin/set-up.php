    ...
    <div class="w-[90%] lg:w-[50%] h-[fit-content] mx-auto bg-white rounded-[24px] p-5">
        ...
        <section class="flex flex-col items-center w-full bg-[#E0F8E9] shadow-lg mt-4 py-3 px-4 rounded relative overflow-hidden">
            ...
            <div class="flex items-center gap-2 mr-auto">
                <img src="./assets/global/success.svg" alt="Success" class="w-[24px]" />
        ...
        <section class="flex flex-col items-center w-full bg-[#FDECEC] shadow-lg mt-4 py-3 px-4 rounded relative overflow-hidden">
            ...
            <div class="flex items-center gap-2 mr-auto">
                <img src="./assets/global/canceldanger.svg" alt="Error" class="w-[24px]" />
                <p class="text-[16px] md:text-[17px] text-[#2C2C2C] w-full font-medium">
                    Error
                </p>
            </div>
        ...
        <p class="text-[#1A237E] font-['Open Sans'] text-[18px] md:text-[20px] font-medium text-center mt-6">
        ...
        <form action="./request-password-setup.php" method="POST" class="flex flex-col gap-4 w-[90%] mx-auto">
            ...
            <button type="submit" class="w-full py-[8px] px-3 bg-[#1A237E] text-white text-[16px] font-['Open Sans'] cursor-pointer rounded-[8px] text-center mt-4">
                Request OTP Code
            </button>
        </form>
    </div>
