...
<div id="cart-drawer" class="fixed top-0 right-0 h-full w-full max-w-[400px] bg-white z-[810] flex flex-col translate-x-full transition-transform duration-300">
    ...
    <div id="cart-drawer-footer" class="px-4 py-3 border-t border-[#E1E1E1] hidden">
        ...
        <a href="<?php echo DOMAIN; ?>/products/cart.php" class="block w-full text-center py-2 px-4 border border-[#C2185B] text-[#C2185B] text-[14px] font-Onest font-medium rounded-[8px] mb-2 hover:bg-[#F5EEF2]">View Cart</a>
        <a href="<?php echo DOMAIN; ?>/products/checkout.php" class="block w-full text-center py-2 px-4 bg-[#C2185B] text-white text-[14px] font-Onest font-medium rounded-[8px] hover:bg-[#ad164b]">Checkout</a>
    </div>
</div>
