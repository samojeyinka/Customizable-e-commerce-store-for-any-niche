...
if (isset($_POST['send'])) {
    ...
    // Modified query to use users table
    $sql = "INSERT INTO users (email, password, otp, status, otp_send_time, ip) VALUES ('$email', '$password', '$otp', 'pending', NOW(), '$ip_address')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        try {
            ...
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Try STARTTLS instead of SMTPS
